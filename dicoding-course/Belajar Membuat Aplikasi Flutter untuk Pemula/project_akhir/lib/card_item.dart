                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      '${widget.daftarMatkulModel.namaMataKuliah}',
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: const TextStyle(fontWeight: FontWeight.bold),
                    ),
                    Text(
                        ' ${widget.daftarMatkulModel.sks.toString()} SKS - ${widget.daftarMatkulModel.jenis} - ${widget.daftarMatkulModel.kategori} - ${widget.daftarMatkulModel.kodeMataKuliah}'),
                  ],
                ),
              ),
              Expanded(
